      ...
      <div>
        ...
        <footer className="footer fixed-bottom text-center">
          <div className="container">
            ...
            Sponsored by <a href="https://www.huntsvillewest.com" target="_blank">Huntsville West</a>. Presented by <a href="https://www.urbanengine.org" target="_blank">Urban Engine</a>.            </p>
          </div>
        </footer>
      </div>
    );
